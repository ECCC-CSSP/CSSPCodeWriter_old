...
namespace CSSPWebToolsAngGenerateCodeHelper
{
    public partial class AngularCodeWriter
    {
        ...
        public void AngularEnumsGenerate()
        {
            ...
            DirectoryInfo diOutputGen = new DirectoryInfo(@"C:\CSSPCode\CSSPWebToolsAng\src\app\enums\generated\");
            ...
            foreach (DLLTypeInfo dllTypeInfoEnums in DLLTypeInfoCSSPEnumsList)
            {
                ...
                if (dllTypeInfoEnums.IsEnum)
                {
                    ...
                    FileInfo fiOutputGen = new FileInfo($@"C:\CSSPCode\CSSPWebToolsAng\src\app\enums\generated\{ dllTypeInfoEnums.Name.ToLower().Replace("enum", ".enum") }.ts");
