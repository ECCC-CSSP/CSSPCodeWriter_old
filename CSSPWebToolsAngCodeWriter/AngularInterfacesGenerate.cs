...
namespace CSSPWebToolsAngGenerateCodeHelper
{
    public partial class AngularCodeWriter
    {
        ...
        public void AngularInterfacesGenerate()
        {
            ...
            DirectoryInfo diOutputGen = new DirectoryInfo(@"C:\CSSPCode\CSSPWebToolsAng\src\app\interfaces\generated\");
        ...
        private void CreateValidationResultTypeFile()
        {
            ...
            FileInfo fiOutputGen = new FileInfo($@"C:\CSSPCode\CSSPWebToolsAng\src\app\interfaces\generated\validationresult.interface.ts");
            using (StreamWriter sw2 = fiOutputGen.CreateText())
            {
                sw2.Write(sb.ToString());
