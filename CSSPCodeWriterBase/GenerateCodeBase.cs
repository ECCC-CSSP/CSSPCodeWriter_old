    ...
    public class GenerateCodeBase
    {
        ...
        public bool SkipType(Type type)
        {
            if (type.Name.StartsWith("<")
                ...
                || type.Name.EndsWith("ExtraA")
                || type.Name.EndsWith("ExtraB")
                || type.Name.EndsWith("ExtraC")
                || type.Name.EndsWith("ExtraD")
                || type.Name.EndsWith("ExtraE")
                || type.Name.EndsWith("ExtraF")
                || type.Name == "CSSPError"
