...
namespace CSSPWebAPIGenerateCodeHelper
{
    public partial class WebAPICodeWriter
    {
        ...
        /// <summary>
        /// Generates:
        ///     C:\CSSPCode\CSSPWebAPI\CSSPWebAPI.Tests\Controllers\Generated\[ModelClassName]ControllerTestGenerated.cs file
        ///
        /// Requires:
        ...
        public void ModelClassNameControllerTestGenerated()
        {
            ...
            foreach (Type type in types)
            {
                ...
                if (!ClassNotMapped)
                {
                    ...
                    FileInfo fiOutputGen = new FileInfo($@"C:\CSSPCode\CSSPWebAPI\CSSPWebAPI.Tests\Controllers\Generated\{ TypeName }ControllerTestGenerated.cs");
