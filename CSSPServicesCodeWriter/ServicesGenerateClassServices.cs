...
namespace CSSPServicesGenerateCodeHelper
{
    public partial class ServicesCodeWriter
    {
        ...
        /// <summary>
        ///     <code>
        ///         Write function to get class name and report part
        ///     </code>       
        /// </summary>
        ...
        private void CreateClassServiceFunctionsPrivateRegionFillClass_x(DLLTypeInfo dllTypeInfo, List<DLLTypeInfo> DLLTypeInfoCSSPModelsList, string TypeName, string TypeNameLower, bool WithDoc)
        {
            ...
            foreach (string ClassName in ClassNameList)
            {
                ...
                if (WithDoc) //------------------------------------------------------------------ help
                {
                    ...
                    sb.AppendLine($@"        /// Fills items [{ currentDLLTypeInfo.Name }](CSSPModels.{ currentDLLTypeInfo.Name }.html) from CSSPDB");
                    sb.AppendLine($@"        /// </summary>");
                    sb.AppendLine($@"        /// <returns>IQueryable of { currentDLLTypeInfo.Name }</returns>");
                }
                ...
                foreach (DLLPropertyInfo dllPropertyInfo in currentDLLTypeInfo.PropertyInfoList)
                {
                    ...
                    if (!modelsGenerateCodeHelper.FillCSSPProp(dllPropertyInfo.PropertyInfo, csspProp, currentDLLTypeInfo.Type))
                    {
                ...
                if (WithDoc)
                {
                    di = new DirectoryInfo($@"C:\CSSPCode\CSSPServices\CSSPServices\srcWithDoc\Extra{ ClassName.Substring(ClassName.Length - 1) }\");
                }
                else
                {
                ...
                if (!di.Exists)
                {
                    ...
                    {
                        StatusPermanentEvent(new StatusEventArgs($"Could not create directory [{ di.FullName }] ..."));
                        return;
                    }
                }
        ...
        /// <summary>
        /// Generates:
        ///     C:\CSSPCode\CSSPServices\CSSPServices\srcWithDoc\[ServiceClassName]ServiceGenerated.cs file
        /// 
        /// Requires:
        ...
        public void ClassNameServiceGenerated(bool WithDoc)
        {
            ...
            foreach (DLLTypeInfo dllTypeInfoModels in DLLTypeInfoCSSPModelsList)
            {
                ...
                if (!NotMappedClass)
                {
                    ...
                    CreateClassServiceFunctionsPrivateRegionFillClass_x(dllTypeInfoModels, DLLTypeInfoCSSPModelsList, dllTypeInfoModels.Type.Name, TypeNameLower, WithDoc);
                ...
                if (WithDoc)
                {
                    fiOutputGen = new FileInfo($@"C:\CSSPCode\CSSPServices\CSSPServices\srcWithDoc\{ dllTypeInfoModels.Type.Name }ServiceGenerated.cs");
                }
                else
                {
                    fiOutputGen = new FileInfo($@"C:\CSSPCode\CSSPServices\CSSPServices\src\{ dllTypeInfoModels.Type.Name }ServiceGenerated.cs");
                }
